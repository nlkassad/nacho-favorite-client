...
/***/ function(module, exports, __webpack_require__) {
	...
	var reviewEvents = __webpack_require__(35);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDisplaySignUp = function onDisplaySignUp(event) {
	  event.preventDefault();
	  ui.displaySignUpSuccess();
	};

	var onDisplaySignIn = function onDisplaySignIn(event) {
	  event.preventDefault();
	  ui.displaySignInSuccess();
	};

	var onDisplayChangePassword = function onDisplayChangePassword(event) {
	  event.preventDefault();
	...
	var showAdminFunctions = function showAdminFunctions(event) {
	  event.preventDefault();
	  ui.showAdminFunctionsSuccess();
	};

	var onGetUsers = function onGetUsers(event) {
	  event.preventDefault();
	  api.getUsers().done(ui.getUsersSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var app = __webpack_require__(6);
	var displaySignIn = __webpack_require__(8);
	var displaySignUp = __webpack_require__(28);
	var displayChangePassword = __webpack_require__(29);
	// const signedUp = require('../templates/signed-up.handlebars');
	var signedIn = __webpack_require__(30);
	var signedOut = __webpack_require__(31);
	var showAdminFunctions = __webpack_require__(32);
	var showReviewsTemplate = __webpack_require__(33);
	...
	var displaySignUpSuccess = function displaySignUpSuccess() {
	...
	var displaySignInSuccess = function displaySignInSuccess() {
	  // const displayAdminSignInSuccess = () => {
	  $('#entry').html(displaySignIn());
	  // $('nav').append('<button id="display-admin" class="btn btn-default">Cheddar!</button>');
	};

	var showAdminFunctionsSuccess = function showAdminFunctionsSuccess() {
	  $('#control').append(showAdminFunctions());
	  $('nav').html("Nacho Favorite &#x1f33d; &#x1f9c0;");
	};

	var displayChangePasswordSuccess = function displayChangePasswordSuccess() {
	...
	module.exports = {
	  success: success,
	  failure: failure,
	  displaySignInSuccess: displaySignInSuccess,
	  displaySignUpSuccess: displaySignUpSuccess,
	  displayChangePasswordSuccess: displayChangePasswordSuccess,
	  showAdminFunctionsSuccess: showAdminFunctionsSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"sign-in\">\n   <fieldset>\n     <legend>Sign in!</legend>\n     <input type=\"email\" name=\"credentials[email]\" placeholder=\"Enter your email\">\n     <input type=\"password\" name=\"credentials[password]\" placeholder=\"Enter your password\">\n     <input type=\"submit\" name=\"submit\" value=\"Sign in!\">\n   </fieldset>\n </form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"sign-up\">\n  <fieldset>\n    <legend>Sign up!</legend>\n    <input type=\"email\" name=\"credentials[email]\" placeholder=\"Enter your email\">\n    <input type=\"password\" name=\"credentials[password]\" placeholder=\"Enter your password\">\n    <input type=\"password\" name=\"credentials[password_confirmation]\" placeholder=\"Confirm your password\">\n    <input type=\"submit\" name=\"submit\" value=\"Sign up!\">\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"change-password\">\n  <fieldset>\n    <legend>Change password</legend>\n    <input type=\"password\" name=\"passwords[old]\" placeholder=\"Enter your old password\">\n    <input type=\"password\" name=\"passwords[new]\" placeholder=\"Enter your new password\">\n    <input type=\"submit\" name=\"submit\" value=\"Change Password\">\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "\n<button id=\"display-create-new-review\" class=\"btn btn-default\">Review Some Nachos!</button>\n<button id=\"getReviewsButton\" class=\"btn btn-default\">Get Reviews!</button>\n<button id=\"getMyReviewsButton\" class=\"btn btn-default\">Get My Reviews!</button>\n<button id=\"display-find-review\" class=\"btn btn-default\">Find a Review</button>\n<button id=\"clearReviewsButton\" class=\"btn btn-default\">Clear Reviews!</button>\n<button id=\"display-change-password\" class=\"btn btn-default\">Change Password</button>\n<button id=\"sign-out\" class=\"btn btn-default\">Sign Out</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<button id=\"display-sign-in\" class=\"btn btn-default\">Sign In!</button>\n<button id=\"display-sign-up\" class=\"btn btn-default\">Sign Up!</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "\n<!-- <button id=\"get-users\" style=\"background-color:yellow\" class=\"btn btn-default\">Get Users</button> -->\n<button id=\"get-menu-items\" style=\"background-color:yellow\" class=\"btn btn-default\">Get Menu Items</button>\n<button id=\"get-restaurants\" style=\"background-color:yellow\" class=\"btn btn-default\">Get Restaurants</button>\n<button id=\"get-dishes\" style=\"background-color:yellow\" class=\"btn btn-default\">Get Dishes</button>\n<button id=\"display-create-menu-item\" style=\"background-color:yellow\" class=\"btn btn-default\">Create Menu Item</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(34),depth0,{"name":"reviews_partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<h1> Reviews: </h1>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.reviews : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3>Menu Item: "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.menu_item : depth0)) != null ? stack1.dish : stack1)) != null ? stack1.name : stack1), depth0))
	    + " Restaurant: "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.menu_item : depth0)) != null ? stack1.restaurant : stack1)) != null ? stack1.name : stack1), depth0))
	    + "</h3>\n\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.rating : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(3, data, 0),"data":data})) != null ? stack1 : "")
	    + "\n"
	    + ((stack1 = helpers["if"].call(alias3,(depth0 != null ? depth0.note : depth0),{"name":"if","hash":{},"fn":container.program(5, data, 0),"inverse":container.program(7, data, 0),"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDisplayCreateNewReview = function onDisplayCreateNewReview(event) {
	  event.preventDefault();
	  api.getMenuItems().done(ui.displayCreateNewReviewSuccess).fail(ui.failure);
	};

	var onDisplayCreateMenuItem = function onDisplayCreateMenuItem(event) {
	  event.preventDefault();
	  ui.displayCreateMenuItemSuccess();
	};

	var onDisplayFindReview = function onDisplayFindReview(event) {
	  event.preventDefault();
	  ui.displayFindReviewSuccess();
	};

	var onGetReviews = function onGetReviews(event) {
	  event.preventDefault();
	  api.getReviews().done(ui.getReviewsSuccess).fail(ui.failure);
	};

	var onGetMenuItems = function onGetMenuItems(event) {
	  event.preventDefault();
	  api.getMenuItems().done(ui.getMenuItemsSuccess).fail(ui.failure);
	};

	var onGetRestaurants = function onGetRestaurants(event) {
	  event.preventDefault();
	  api.getRestaurants().done(ui.getRestaurantsSuccess).fail(ui.failure);
	};

	var onGetDishes = function onGetDishes(event) {
	  event.preventDefault();
	  api.getDishes().done(ui.getDishesSuccess).fail(ui.failure);
	};

	var onGetMyReviews = function onGetMyReviews(event) {
	  event.preventDefault();
	  api.getMyReviews().done(ui.getMyReviewsSuccess).fail(ui.failure);
	};

	var onClearReviews = function onClearReviews(event) {
	  event.preventDefault();
	  ui.clearReviews();
	};
	...
	var onDisplayEditReview = function onDisplayEditReview(event) {
	  event.preventDefault();
	...
	var onVote = function onVote(event) {
	  event.preventDefault();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createNewReview = function createNewReview(data) {
	  return $.ajax({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showReviewsTemplate = __webpack_require__(33);
	var showListingTemplate = __webpack_require__(38);
	var showMyReviewsTemplate = __webpack_require__(39);
	var displayCreateNewReview = __webpack_require__(41);
	var showNewReview = __webpack_require__(42);
	var displayFindReview = __webpack_require__(43);
	var showReview = __webpack_require__(44);
	var displayEditReview = __webpack_require__(45);
	var displayCreateMenuItem = __webpack_require__(46);

	var displayCreateNewReviewSuccess = function displayCreateNewReviewSuccess(menu_items) {
	  $('#entry').html(displayCreateNewReview(menu_items));
	};

	var displayCreateMenuItemSuccess = function displayCreateMenuItemSuccess() {
	...
	module.exports = {
	  displayCreateNewReviewSuccess: displayCreateNewReviewSuccess,
	  displayCreateMenuItemSuccess: displayCreateMenuItemSuccess,
	  displayFindReviewSuccess: displayFindReviewSuccess,
	  displayEditReviewSuccess: displayEditReviewSuccess,
	  createNewReviewSuccess: createNewReviewSuccess,
	  createMenuItemSuccess: createMenuItemSuccess,
	  editReviewSuccess: editReviewSuccess,
	  findReviewSuccess: findReviewSuccess,
	  getReviewsSuccess: getReviewsSuccess,
	  getMenuItemsSuccess: getMenuItemsSuccess,
	  getRestaurantsSuccess: getRestaurantsSuccess,
	  getDishesSuccess: getDishesSuccess,
	  getMyReviewsSuccess: getMyReviewsSuccess,
	  clearReviews: clearReviews,
	  deleteReviewSuccess: deleteReviewSuccess,
	  failure: failure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <ul class=\"list\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.restaurants : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </ul>\n";
	  ...
	  return "      <li>"
	    ...
	    + "</li>\n"
	    + ((stack1 = helpers.each.call(alias1,((stack1 = (depth0 != null ? depth0.restaurants : depth0)) != null ? stack1.reviews : stack1),{"name":"each","hash":{},"fn":container.program(3, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"3":function(container,depth0,helpers,partials,data) {
	    var helper;
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.menu_items : depth0),{"name":"if","hash":{},"fn":container.program(6, data, 0),"inverse":container.program(9, data, 0),"data":data})) != null ? stack1 : "");
	},"6":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "  <ul class=\"list\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.menu_items : depth0),{"name":"each","hash":{},"fn":container.program(7, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </ul>\n";
	},"7":function(container,depth0,helpers,partials,data) {
	  ...
	  return "      <li>"
	    ...
	    + " "
	    + alias4(((helper = (helper = helpers.restaurant_id || (depth0 != null ? depth0.restaurant_id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"restaurant_id","hash":{},"data":data}) : helper)))
	    + " "
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.restaurant : depth0)) != null ? stack1.name : stack1), depth0))
	    + " "
	    + alias4(((helper = (helper = helpers.dish_id || (depth0 != null ? depth0.dish_id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"dish_id","hash":{},"data":data}) : helper)))
	    + " "
	    + alias4(alias5(((stack1 = (depth0 != null ? depth0.dish : depth0)) != null ? stack1.name : stack1), depth0))
	    + "</li>\n";
	},"9":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.dishes : depth0),{"name":"if","hash":{},"fn":container.program(10, data, 0),"inverse":container.program(13, data, 0),"data":data})) != null ? stack1 : "");
	},"10":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "  <ul class=\"list\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.dishes : depth0),{"name":"each","hash":{},"fn":container.program(11, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </ul>\n";
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.users : depth0),{"name":"if","hash":{},"fn":container.program(14, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"14":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "  <ul class=\"list\">\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.users : depth0),{"name":"each","hash":{},"fn":container.program(15, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  </ul>\n";
	  ...
	  return "<h1> Results: </h1>\n"
	    + ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.restaurants : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.program(5, data, 0),"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = container.invokePartial(__webpack_require__(40),depth0,{"name":"my_reviews_partial","data":data,"indent":"  ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<h3>Menu Item: "
	    ...
	    + " class=\"btn btn-default display-edit-review\">Edit Review</button>\n<button id="
	    + alias2(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias4),(typeof helper === alias5 ? helper.call(alias3,{"name":"id","hash":{},"data":data}) : helper)))
	    + " class=\"btn btn-default delete-review\">Delete Review</button>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<form id=\"create-new-review\">\n  <fieldset>\n    <legend>Review Some Nachos!\n    </legend>\n    <!-- <p>&#x1f607; Damn that's Nachoie!</p>\n    <p>	&#x1f610; Meh</p>\n    <p>&#x1f47f; Cook's got a chip on their shoulder</p> -->\n    <select class=\"menu-item-selector\">\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<h3>New Review: </h3>\n<p>"
	    ...
	    + "\n"
	    + alias2(alias1(((stack1 = (depth0 != null ? depth0.review : depth0)) != null ? stack1.note : stack1), depth0))
	    + "</p>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"find-review\">\n  <fieldset>\n    <legend>Find a Nacho Review</legend>\n    <input type=\"menu_item\" name=\"menu_item[id]\" placeholder=\"Enter the Menu Item ID\">\n    <input type=\"submit\" name=\"submit\" value=\"Find\">\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n<h3>Review: </h3>\n<p><strong> Dish ID:</strong> "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.menu_item : depth0)) != null ? stack1.dish : stack1)) != null ? stack1.name : stack1), depth0))
	    + " <strong>Restaurant ID:</strong> "
	    + alias2(alias1(((stack1 = ((stack1 = (depth0 != null ? depth0.menu_item : depth0)) != null ? stack1.restaurant : stack1)) != null ? stack1.name : stack1), depth0))
	    + "\n</p>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},((stack1 = (depth0 != null ? depth0.menu_item : depth0)) != null ? stack1.reviews : stack1),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form id=\"create-menu-item\">\n  <fieldset>\n    <legend>Create a Menu Item</legend>\n    <input type=\"dish_id\" name=\"menu_item[dish_id]\" placeholder=\"Enter the Dish ID\">\n    <input type=\"restaurant_id\" name=\"menu_item[restaurant_id]\" placeholder=\"Enter Restaurant ID\">\n    <input type=\"submit\" name=\"submit\" value=\"Submit Item\">\n  </fieldset>\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "56c036e9c26cb333c82fdb5dcd95edc7.jpg";
